...
```` php
composer require tyleteam/kakao-api
````
...
```` php
'providers' => [
    tyleteam\KakaoApi\KakaoApiServiceProvider::class,
]
````
...
```` php
'aliases' => [
    'Kakao' => tyleteam\KakaoApi\KakaoApiFacade::class,
];
````
